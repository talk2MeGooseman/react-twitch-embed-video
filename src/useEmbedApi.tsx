...
const useTwitchEmbed = (props: (IChannelEmbedParameters | IVodCollectionEmbedParameters | IVodEmbedParameters) ) => {
  const [embed, setEmbed] = useState<ITwitchEmbed>()

  const initialize = useCallback(() => {
    const twitchEmbed = new (root as unknown as ITwitchWindow).Twitch.Embed(props.targetId ?? '', {
      ...props
    })
