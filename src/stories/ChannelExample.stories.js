...
export default {
  ...
  parameters: {
    docs: {
        description: {
            component: "Take control of the Twitch Player component in this example and control all aspects of the player. Choose a channel you want to display or change some of the default configurations."
        }
    },
  }
};
