...
var _jsxFileName = '/Users/admin/Desktop/react-twitch-embed-video/src/index.js';
...
var TwitchEmbedVideo = function (_PureComponent) {
    ...
    _createClass(TwitchEmbedVideo, [{
        ...
        value: function componentDidMount() {
            ...
            var embed = void 0;
            if (__WEBPACK_IMPORTED_MODULE_2_window_or_global___default.a.Twitch && __WEBPACK_IMPORTED_MODULE_2_window_or_global___default.a.Twitch.Embed) {
                embed = new __WEBPACK_IMPORTED_MODULE_2_window_or_global___default.a.Twitch.Embed(this.props.targetClass, Object.assign({}, this.props));
                this._addEventListeners(embed);
            } else {
                var script = document.createElement('script');
                script.setAttribute('src', EMBED_URL);
                script.addEventListener('load', function () {
                    embed = new __WEBPACK_IMPORTED_MODULE_2_window_or_global___default.a.Twitch.Embed(_this2.props.targetClass, Object.assign({}, _this2.props));
        ...
        value: function _addEventListeners(embed) {
            embed.addEventListener(__WEBPACK_IMPORTED_MODULE_2_window_or_global___default.a.Twitch.Embed.AUTHENTICATE, function (user) {
                if (this.props.onUserLogin) {
                    this.props.onUserLogin(user);
                }
            }.bind(this));

            embed.addEventListener(__WEBPACK_IMPORTED_MODULE_2_window_or_global___default.a.Twitch.Embed.VIDEO_PLAY, function (data) {
            ...
            embed.addEventListener(__WEBPACK_IMPORTED_MODULE_2_window_or_global___default.a.Twitch.Embed.VIDEO_READY, function () {
        ...
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { id: this.props.targetClass, __source: {
