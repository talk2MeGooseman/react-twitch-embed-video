...
declare const _default: default_2.MemoExoticComponent<{
    (props: IChannelEmbedParameters | IVodCollectionEmbedParameters | IVodEmbedParameters): default_2.JSX.Element;
    defaultProps: {
        targetId: string;
        width: string;
        height: string;
...
declare interface IBaseEmbedParameters {
     ...
     *
     * _video: Default if channel is not provided. Shows only the video player (omits chat). */
    layout?: 'video' | 'video-with-chat';
    /** Specifies whether the initial state of the video is muted. _Default: false. */
    muted?: boolean;
     ...
     *
     * _Default: light or the users chosen theme on Twitch. */
    theme?: 'light' | 'dark';
...
declare type IVideoPlayEventCallback = () => void;

declare type IVideoReadyEventCallback = (player: IPlayerInterface) => void;
